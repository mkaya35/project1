...
public class WebTableTest{
  ...
  public static void main(String[] args) throws InterruptedException {
	  ...
	  System.setProperty("webdriver.chrome.driver", "C:\\Users\\Mevlut\\Google Drive\\A-learn\\Eclipse\\chromedriver.exe");
	    ...
	    driver.get("http://test1.sivri.us/index.php/webtable/");


		WebTable table = new WebTable(driver.findElement(By.xpath("//table[@id = 'testaccounts']")));
	    ...
	    System.out.println("Cell Text  which contains 'er5': " + table.getCellElement("er5").getText());
	    ...
	    System.err.println("Row text  which contains 'wd4' : " + table.getRowElement("wd4").getText());
